	...
	?>
      <div class="row carousel-row">
        ...
        <div class='slide-row'>
		  ...
		  echo"<span class='pull-right buttons'>";
			if($this->session->userdata('username')&&$id==$sess['username']){
				echo"<button class='fa fa-cog fa-fw' onClick='window.location.href = '../../../../pages/editproduct/".$data[(($ppage*3)-2)]['id']."';'><i class='fa fa-fw fa-eye'></i> Edit</button>";
        ...
        <div class='slide-row'>
		  ...
		  echo"<span class='pull-right buttons'>";
			if($this->session->userdata('username')&&$id==$sess['username']){
				echo"<button class='fa fa-cog fa-fw' onClick='window.location.href = '../../../../pages/editproduct/".$data[(($ppage*3)-1)]['id']."';'><i class='fa fa-fw fa-eye'></i> Edit</button>";
        ...
        <div class='slide-row'>
		  ...
		  echo"<span class='pull-right buttons'>";
			if($this->session->userdata('username')&&$id==$sess['username']){
				echo"<button class='fa fa-cog fa-fw' onClick='window.location.href = '../../../../pages/editproduct/".$data[(($ppage*3))]['id']."';'><i class='fa fa-fw fa-eye'></i> Edit</button>";
