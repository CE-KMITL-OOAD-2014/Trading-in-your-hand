      ...
      <div class="col-xs-18 col-sm-6 col-md-3">
        <div class="thumbnail"> <img src="../../productPic/<? echo"".$data[1]['pic1']; ?>.jpg" alt="">
          <div class="caption">
            ...
            <p><? echo"<b>Owner :</b>&nbsp;<a href='/member/".$data[1]['username']."'>".$data[1]['username']; ?></a></p>
      ...
      <div class="col-xs-18 col-sm-6 col-md-3">
        <div class="thumbnail"> <img src="../../productPic/<? echo"".$data[2]['pic1']; ?>.jpg" alt="">
          <div class="caption">
            ...
            <p><? echo"<b>Owner :</b>&nbsp;<a href='/member/".$data[2]['username']."'>".$data[1]['username']; ?></a></p>
      ...
      <div class="col-xs-18 col-sm-6 col-md-3">
        <div class="thumbnail"> <img src="../../productPic/<? echo"".$data[3]['pic1']; ?>.jpg" alt="">
          <div class="caption">
            ...
            <p><? echo"<b>Owner :</b>&nbsp;<a href='/member/".$data[3]['username']."'>".$data[1]['username']; ?></a></p>
      ...
      <div class="col-xs-18 col-sm-6 col-md-3">
        <div class="thumbnail"> <img src="../../productPic/<? echo"".$data[4]['pic1']; ?>.jpg" alt="">
          <div class="caption">
            ...
            <p><? echo"<b>Owner :</b>&nbsp;<a href='/member/".$data[4]['username']."'>".$data[1]['username']; ?></a></p>
